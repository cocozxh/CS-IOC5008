...
#                                   np.floor(3e-2 * np.shape(image)[1] + 0.5).astype('int32'))
...
#             print(img_dic)
#             img_dic['label'] = [10  if j ==0 else j for j in img_dic['label']]
...
# if not os.path.exists('/output/out0/'):
#     os.makedirs('/output/out0/')
